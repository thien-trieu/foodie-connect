// const { ChoicesModel } = require('../models');
...
//     .then(choices => {
//       if (choices.length === 0) {
//         return res.status(200).send({ message: 'No choices available!' });
//       }

//       res.status(200).send({ message: 'List of all choices!', choices });
//     })
//     .catch(error => {
//       console.log(error.message);
//       res
//         .status(500)
//         .send({ message: 'Error reading choices', error: error.message });
//     });
// };
