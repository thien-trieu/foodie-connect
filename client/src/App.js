...
// import { fetchLocation, getApi } from './helper/fetchLocation';
...
const client = StreamChat.getInstance(window.env.STREAM_API_KEY);
...
export default function App() {
  ...
  useEffect(() => {
   ...
   const fetchData = async () => {
    await fetchRestaurants("Vancouver", "Burgers", setResData)
    }
